  ...
  >
    <div class="flex justify-between">
      ...
      <button
        ...
        data-bs-target="#AddModal">Add Categories</button
      >
    </div>
          ...
          <div class="grid grid-cols-1 gap-4">
            <div class="mb-6">
              ...
              <input
                type="text"
                id="product-input"
                placeholder="Please input your categories name"
                bind:value={cate_name}
            ...
            <div class="grid grid-cols-1">
              <label
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                for="default_size">Upload Image Categories</label
              >
              <input
                bind:this={cate_image}
