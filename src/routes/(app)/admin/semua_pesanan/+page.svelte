						...
						<tr id="accordion-collapse" data-accordion="collapse">
							...
							<td class="flex justify-center content-center ">
								...
								<div id="accordion-collapse" data-accordion="collapse">
									<button type="button"  data-accordion-target="#accordion-collapse-body-1" aria-expanded="false" aria-controls="accordion-collapse-body-1">
												...
												<div class="col-span-8 border-b border-gray-300 cursor-pointer">
													<div class="mb-3 font-normal text-gray-700 dark:text-gray-400">
														<div class=" py-2 w-full ml-5 flex items-start">
															<img
																src={detail.prod_image
																? `${url_API}/products/image/${detail.prod_image}`
																: '/product-default.png'}
																class="w-24"
																alt=""
															/>
															<div>
																<p class="text-medium font-semibold text-black">{detail.prod_name} <br><span class="font-medium text-base">x {detail.cart_qty}</span></p>
															</div>
														</div>
													</div>
												</div>
												<div class="border-b border-gray-300">
													<h5 class="font-semibold text-xl text-red-500 flex justify-end">{`Rp ${Number(detail.prod_price).toLocaleString('id-ID')}`}</h5>
												</div>
												{/each}
											</div>
											<div class="grid grid-cols-9 mt-3">
												...
												<div class="col-span-2">
													...
													<div class="flex">
														...
														<div class="flex-initial w-32">
															{#each detailProduct as detail }
																<div class="py-2 w-full ml-5 flex items-start">
																	<p class="text-xl font-semibold text-red-500">{`Rp ${Number(parseFloat(detail.prod_price + ongkir)).toLocaleString('id-ID')}`}</p>
																</div>
															{/each}
														</div>
													</div>
