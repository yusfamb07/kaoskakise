  ...
  async function getProduct() {
    try {
      const res = await dataAPI.get(
        `/products/customer/all?page=${page}&record=8`
      );
...
<div class="container lg mx-auto">
  <div class="flex flex-col lg:flex-row lg:justify-between items-center mt-4">
    <div>
      <h1 class="lg:text-xl sm:text-lg font-belanosima d-flex justify-center">
        NEW PRODUCT
      </h1>
  ...
  <div id="carouselExampleIndicators" class="carousel slide">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <div
          class="grid lg:grid-cols-4 gap-4 sm:grid-cols-2 mt-4 justify-items-center"
        >
              ...
              >
                <img
                  src={post.prod_image
                    ? `${url_API}/products/image/${post?.prod_image}`
                    : "/product-default.png"}
                  class="lg:w-80 sm:w-40 lg:h-72 sm:h-36"
                  alt=""
                />
                <div class="card-body">
                  <h2
                    class="card-title text-xl font-black leading-6 text-center"
                  >
                    {post.prod_name}
                  </h2>
        ...
        >
          {#each products as post}
            ...
            >
              ...
              <div class="card-body">
                <h1
                  class="card-title text-2xl font-nats font-black leading-6 text-center"
                >
                  {post.prod_name}
                </h1>
                <p class="card-text text-center">
  ...
  <div class="container lg mx-auto">
    <h1
      class="lg:text-xl sm:text-lg font-belanosima d-flex justify-center mt-4"
    >
      CATEGORIES
    </h1>
    <div class="flex justify-center">
      ...
      {#each categories as item}
        <div class="card border-none">
          <img
            ...
            alt=""
          />
          <!-- <img src="/active.jpg" class="card-img-top h-80 w-100" alt="..." /> -->
          <div class=" bg-black sm:h-14">
            <h1
  ...
  <h1 class="lg:text-xl sm:text-lg font-belanosima d-flex justify-center mt-4">
    OUR GALLERY
  </h1>
  <div class="flex justify-center">
    <div class="border-b border-black border-1 w-32"></div>
  ...
  <div class="row mt-3">
    <div class="col-md-8">
      <img
        src="/gallery2.png"
        class=" w-100 h-30 mb-2 mb-md-4 shadow-1-strong cursor-zoom-in"
        data-bs-toggle="modal"
    ...
    <div class="col-md-4">
      <img
        src="/gallery4.jpg"
        class=" w-30 h-100 mb-2 mb-md-4 shadow-1-strong cursor-zoom-in"
        data-bs-toggle="modal"
        data-bs-target="#galleryModal"
        alt=""
      />
